...
**Clinic Database** is a database project that uses a relational database to create the data structure for a clinic.
...
Clone this repository to your desired folder: `git clone https://github.com/binyamolango/clinic-database`
